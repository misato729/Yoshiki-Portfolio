  ...
  <section id="skills">
    ...
    $skill_sections = [
      ...
      [
        ...
        'desc' => 'フロントエンドを中心にフルスタックに学習中です。Vue.js+LaravelのWebアプリ開発が最も注力したところで、最近はReact/Next.jsも学習中です。'
      ],
      [
